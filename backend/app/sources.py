...
SOURCES = [
    ...
    {"key": "violation_tracker", "name": "Violation Tracker", "url": "https://violationtracker.goodjobsfirst.org/", "category": "Cross-agency enforcement evidence · free public search only", "status": "not_implemented"},
